...
export function DetailSheet({
  ...
  return (
    <AnimatedSheet
      ...
      panelClassName="flex max-h-[min(92dvh,92vh)] w-full max-w-lg flex-col overflow-hidden rounded-t-[16px] bg-white shadow-xl dark:bg-[var(--color-surface)] lg:rounded-[16px]"
    >
      {report && (
        <>

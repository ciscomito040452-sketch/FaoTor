    ...
    >
      ...
      <section id="report-workspace" ref={workspaceRef}>
        <Card padding="lg" className="hidden overflow-hidden xl:block">
          <div className="grid max-h-[min(72vh,calc(100vh-14rem))] grid-cols-1 gap-6 overflow-hidden xl:grid-cols-[minmax(0,0.88fr)_minmax(420px,1.12fr)] xl:grid-rows-[minmax(0,1fr)] xl:items-stretch">
